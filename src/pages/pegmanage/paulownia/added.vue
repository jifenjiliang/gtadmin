<template>
  <div class="addcolumn">
    <section class="section">
      <div class="loation"><router-link to="/paulownia">PGC内容管理</router-link>>><router-link to="/paulownia">金桐精选</router-link>>>新增精选</div>
          ...
          <el-col :span="24">
            <el-form ref="form" :model="form" label-width="80px">
              ...
              <div class="col_button">
                ...
                <el-button><router-link to="/paulownia">取消</router-link></el-button>
              </div>
            </el-form>
          </el-col>
        </el-row>
          ...
          that.$http.post(that.serverapi,JSON.stringify(savepath),{headers:{
            ...
            function (res) {
              if(res.body.notification.notifCode == 0){
                this.$message('创建推送精选成功');
                this.$router.push({path: '/paulownia'})
              }else{
                this.$notify.error({
                  title: '添加失败',
                  message: '创建推送精选成功',
