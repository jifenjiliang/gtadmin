<template>
  <div class="addcolumn">
    <section class="section">
      <div class="loation"><router-link to="/paulownia">PGC内容管理</router-link>>><router-link to="/paulownia">金桐精选</router-link>>>编辑精选</div>
  ...
  export default {
    ...
    mounted:function () {
      this.$nextTick(function () {
        var that =  this;
        let Data = JSON.parse(localStorage.getItem('jinxun'));
        ...
        that.$http.post(that.serverapi,JSON.stringify(savepath),{headers:{
          ...
          function (res) {
            if(res.body.notification.notifInfo == "success"){
              ...
              that.loading = false;
              localStorage.removeItem('jinxun');
            }else{
              this.$notify.error({
                title: '编辑精选失败',
                message: '编辑精选失败',
