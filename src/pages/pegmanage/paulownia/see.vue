<template>
  <div class="see" >
    <section class="section">
      <div class="loation">
        <router-link to="/paulownia">UGC内容管理</router-link> >>><router-link to="/paulownia">金桐精选</router-link> >>查看
      </div>
      <!-- topic body -->
    ...
    <!-- comment_body end -->
    <div class="back">
      <router-link to="/paulownia"> <el-button type="success">&nbsp;返回&nbsp;</el-button></router-link>
    </div>
  </div>
</template>
